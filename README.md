...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/nameless-shadow-7990)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-shadow-7990
```

A live public deployment of this template is available at [https://nameless-shadow-7990.templates.workers.dev](https://nameless-shadow-7990.templates.workers.dev)
